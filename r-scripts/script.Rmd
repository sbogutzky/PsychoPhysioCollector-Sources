...
plot(sensor.bd38.subset.hrv$RRInterval)
...
m   <- 1
n   <- nrow(motion.sensor.data.subset[motion.sensor.data.subset$Timestamp < 5 * 60 * 1000, ])
...
title(main = paste("Activity: Walking, Sex: Female, Start:", "Datum", ", End, Subset 1/4", sub = "LF: / HF: / LF/HF: / "))
