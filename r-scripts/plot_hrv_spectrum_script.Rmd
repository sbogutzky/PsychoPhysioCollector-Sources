...
```{r plot-rr-intervals-and-psd}
  ...
  title(main = "FFT spectrum (Welch’s periodogram: 256 s window with 50% overlap)", sub = paste("LF: ", round(spss.hrv.data$lfpowfft, 1), " ms^2, HF: ", round(spss.hrv.data$hfpowfft, 1), " ms^2, LF/HF: ", round(spss.hrv.data$lfhffft, 1), ", Flow : ", fss.factors$flow[subset], sep = ""))
