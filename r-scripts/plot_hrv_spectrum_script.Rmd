...
```{r plot-rr-intervals-and-psd}
  ...
  # extract rr intervals and psd values 
    ...
    # plot rr intervals and psd
      ...
      plot(t, rr.intervals, type = "l", xlab = "Time (s)", ylab = "RR Interval (s)", xaxs = "i", yaxs = "i", xaxt = "n")
      ...
      plot(freq, spec, type = "l", xlab = "Frequency (Hz)", ylab = "PSD (s^2/Hz)", xaxs = "i", yaxs = "i", ylim = c(0, ylim.2), xaxt = "n")
