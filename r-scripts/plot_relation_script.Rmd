  ...
  for (directory in directories) {
    ...
    # extract rr intervals and psd values 
      ...
      rr.intervals    <- rr.intervals[!is.na(rr.intervals)]
        ...
        hrv.frequency.domain.parameters <- CalculateHRVFrequencyDomainParameters(times, rr.intervals, band.range.ulf, band.range.vlf, band.range.lf, band.range.hf, band.range.vhf, 4, 256, .5) 
