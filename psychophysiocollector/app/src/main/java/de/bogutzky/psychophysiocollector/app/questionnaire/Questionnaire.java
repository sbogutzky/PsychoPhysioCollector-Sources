...
public class Questionnaire {
    ...
    public void showQuestionnaire() {
        ...
        questionnaireDialog.setTitle(activity.getString(R.string.feedback));
    ...
    public void saveQuestionnaireItems(File root, String headerComments, String footerComments, long startActivityTimestamp) {
